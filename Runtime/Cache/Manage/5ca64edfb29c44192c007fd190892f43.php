...
<head>
    ...
    <title><?php echo ($system["sitename"]); ?>后台管理中心 - 商品管理 - 修改商品</title>
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li>
                            <a href="/tpshop/index.php/Manage/Goods/Index">商品列表</a>
                        </li>
                        <li>
                            <strong>修改商品</strong>
                        </li>
                    ...
                    <div class="col-lg-12">
                        <div class="ibox float-e-margins">
                            ...
                            <div class="ibox-content">
                                <form  role="form" id="form1" method="post"  action="/tpshop/index.php/Manage/Goods/save_editGoods" class="form-horizontal" enctype="multipart/form-data" />
                                <?php if(is_array($goods)): $i = 0; $__LIST__ = $goods;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="form-group">
                                        <label class="col-sm-2 control-label">商品名称</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="title" value="<?php echo ($vo["title"]); ?>"  id="title" placeholder="请输入商品名称">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <select class="form-control m-b" name="brand">
                                                ...
                                                <?php if(is_array($brand)): $i = 0; $__LIST__ = $brand;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$b): $mod = ($i % 2 );++$i;?><option value="<?php echo ($b["b_id"]); ?>" <?php if($b['b_id'] == $vo['pinpai']['b_id']): ?>selected<?php endif; ?>><?php echo ($b["brand"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="hr-line-dashed"></div>
                                  ...
                                  <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            <option value="0">请选择商品分类</option>
                                                <?php if(is_array($cate)): $i = 0; $__LIST__ = $cate;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$c): $mod = ($i % 2 );++$i;?><option value="<?php echo ($c["id"]); ?>" <?php if($c['id'] == $vo['cate']['id']): ?>selected<?php endif; ?>><?php echo ($c["html"]); echo ($c["name"]); ?></option></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="hr-line-dashed"></div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                        <img src="/tpshop/Public/<?php echo ($vo["photo"]); ?>" class="thumbnail" height="100">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="model" value="<?php echo ($vo["model"]); ?>"  placeholder="请输入商品规格">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="price" value="<?php echo ($vo["price"]); ?>" placeholder="请输入商品价格">
                                        </div>
                                    </div>
                                    <div class="hr-line-dashed"></div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="num" value="<?php echo ($vo["num"]); ?>" placeholder="请输入商品数量 ">
                                        </div>
                                    </div>
                                    <div class="hr-line-dashed"></div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input name="free_shipping" type="radio" value="1" <?php if($vo["free_shipping"] == 1): ?>checked<?php endif; ?>>
                                            <label class="control-label">包邮</label>
                                            <input name="free_shipping" type="radio" value="0" <?php if($vo["free_shipping"] == 0): ?>checked<?php endif; ?>>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input name="tuijian" type="radio" value="1" <?php if($vo["tuijian"] == 1): ?>checked<?php endif; ?>>
                                            <label class="control-label">推荐</label>
                                            <input name="tuijian" type="radio" value="0" <?php if($vo["tuijian"] == 0): ?>checked<?php endif; ?>>
                                            <label class="control-label">取消推荐</label>
                                        </div>
                                    </div>
                                    <div class="hr-line-dashed"></div>
