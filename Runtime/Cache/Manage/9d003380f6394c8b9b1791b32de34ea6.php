...
<head>
    ...
    <title><?php echo ($system["sitename"]); ?>后台管理中心 - 内容管理 - 单页管理</title>
...
<body>
                    ...
                    <div class="col-lg-12">
                        <div class="ibox float-e-margins">
                            ...
                            <div class="ibox-content">
                                <form  role="form" id="form" method="post"  action="/Shop/index.php/Manage/News/save_edit_about" class="form-horizontal" />
                                <?php if(is_array($news)): $i = 0; $__LIST__ = $news;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="form-group">
                                        <label class="col-sm-2 control-label">标题</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="n_title" value="<?php echo ($vo["n_title"]); ?>" placeholder="请输入标题">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            <?php if(is_array($newscate)): $i = 0; $__LIST__ = $newscate;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$c): $mod = ($i % 2 );++$i;?><option value="<?php echo ($c["c_id"]); ?>" <?php if($vo['cate_id'] == $c['c_id']): ?>selected<?php endif; ?>><?php echo ($c["c_title"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>    
                                            </select>
                                        </div>
                                    </div>
                                    <div class="hr-line-dashed"></div>
                                  ...
                                  <div class="form-group" id="data_1">
                                      ...
                                      <div class="col-sm-10 input-group date">
                                          ...
                                          <input type="text" class="form-control" name="n_date" value="<?php echo ($vo["n_date"]); ?>">
                                      </div>
                                  </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" name="n_type" value="<?php echo ($vo["n_type"]); ?>">
                                        <input type="hidden" name="n_id" value="<?php echo ($vo["n_id"]); ?>">
    ...
    <!-- Script kindeditor -->
    <script charset="utf-8" src="/Shop/Public/kindeditor/kindeditor-all-min.js"></script>
	<script charset="utf-8" src="/Shop/Public/kindeditor/lang/zh-CN.js"></script>
    <script>
    ...
    <script src="/Shop/Public/js/plugins/validate/messages_zh.min.js"></script>
        <!-- Data picker -->
    <script src="/Shop/Public/js/plugins/datapicker/bootstrap-datepicker.js"></script>
