            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li>
                            <a href="/KeNong/index.php/Manage/News/about">单页管理</a>
                        </li>
                        <li>
                            <strong>编辑内容</strong>
                        </li>
                    ...
                    <div class="col-lg-12">
                        <div class="ibox float-e-margins">
                            ...
                            <div class="ibox-content">
                                <form  role="form" id="form" method="post"  action="/KeNong/index.php/Manage/News/save_edit_about" class="form-horizontal" />
