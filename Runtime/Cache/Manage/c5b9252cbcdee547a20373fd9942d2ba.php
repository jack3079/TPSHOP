...
<head>
    ...
    <title><?php echo ($system["sitename"]); ?>后台管理中心 - 商品分类 - 分类列表</title>
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li>
                            <a href="/Nongke/index.php/Manage/Category/index">商品分类</a>
                        </li>
                        <li>
                            <strong>分类列表</strong>
                        </li>
                        ...
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                ...
                                <div class="ibox-tools">
                                    ...
                                    <a title="添加分类" href="/Nongke/index.php/Manage/Category/addCategory" class="close-link">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped">
                                        ...
                                        <?php if(is_array($Category)): $i = 0; $__LIST__ = $Category;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                                ...
                                                <td><?php if($vo["pid"] == 0): ?>顶级分类<?php else: echo ($vo["cate"]["name"]); endif; ?></td>
                                                <td><?php echo ($vo["sort"]); ?></td>
                                                <td>
                                                <a href="/Nongke/index.php/Manage/Category/editCategory/id/<?php echo ($vo["id"]); ?>"><i class="fa fa-edit text-navy"></i></a>
                                                <a href="/Nongke/index.php/Manage/Category/del_cate/id/<?php echo ($vo["id"]); ?>"><i class="fa  fa-trash-o text-danger"></i></a>
                                                </td>
