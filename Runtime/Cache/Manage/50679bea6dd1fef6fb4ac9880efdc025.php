...
<head>
    ...
    <link href="/kenong/Public/js/plugins/fancybox/jquery.fancybox.css" rel="stylesheet">
...
<body>
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li>
                            <a href="/kenong/index.php/Manage/Goods/index">商品管理</a>
                        </li>
                        <li>
                            <strong>商品列表</strong>
                        </li>
                        ...
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                ...
                                <div class="ibox-tools">
                                    ...
                                    <a title="添加商品" href="/kenong/index.php/Manage/Goods/addGoods" class="close-link">
                            ...
                            <form action="/kenong/index.php/Manage/Goods/Index"  method="post">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-hover">
                                        ...
                                        <?php if(is_array($goods)): $i = 0; $__LIST__ = $goods;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                                ...
                                                <td>
                                                <a class="fancybox" href="/kenong/Public/<?php echo ($vo["photo"]); ?>" title="<?php echo ($vo["title"]); ?>">
                                                <img alt="<?php echo ($vo["title"]); ?>" src="/kenong/Public/<?php echo ($vo["photo"]); ?>" style=" height:50px; width:auto;">
                                                </a>
                                                </td>
                                                ...
                                                <td>
                                                <a href="/kenong/index.php/Manage/Goods/editGoods/id/<?php echo ($vo["id"]); ?>"><i class="fa fa-edit text-navy"></i></a>
                                                <a href="/kenong/index.php/Manage/Goods/delGoods/id/<?php echo ($vo["id"]); ?>"><i class="fa  fa-trash-o text-danger"></i></a>
                                                </td>
    ...
    <script src="/kenong/Public/js/plugins/fancybox/jquery.fancybox.js"></script>
    <script>
        ...
        $("#quanxuan").bind('click',function(){
            ...
            $("#shanchu").bind('click',function(){
                ...
                if(confirm("您确定要删除所有选中数据吗？")){
                    ...
                    $.ajax({ 
                        type:"POST",
                        url:"/kenong/index.php/Manage/Goods/delGoods",
                        data:"id="+array,
