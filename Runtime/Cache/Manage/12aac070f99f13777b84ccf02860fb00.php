...
<head>
    ...
    <title><?php echo ($system["sitename"]); ?>后台管理中心 - 短信设置</title>
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li>
                            <a href="/KeNong/index.php/Manage/System/index">商城设置</a>
                        </li>
                        <li>
                            <strong>短信设置</strong>
                        </li>
                    ...
                    <div class="col-lg-12">
                        <div class="ibox float-e-margins">
                            ...
                            <div class="ibox-content">
                                <form  role="form" id="form" method="post" action="/KeNong/index.php/Manage/System/saveSite" class="form-horizontal" />
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">短信接口URL</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="smsurl" value="<?php echo ($system["smsurl"]); ?>" placeholder="请输入短信接口网址">
                                            <span class="help-block m-b-none">短信接口申请：http://www.juhe.cn/docs/api/id/54</span>
                                        </div>
                                    </div>
                                    <div class="hr-line-dashed"></div>

                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">短信接口APPKEY</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="smsapi" value="<?php echo ($system["smsapi"]); ?>" placeholder="请输入短信接口APPKEY">
                                        </div>
                                    </div>
