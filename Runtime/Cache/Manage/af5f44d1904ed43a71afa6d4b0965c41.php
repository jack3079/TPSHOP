...
<body>
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li>
                            <a href="/tpshop/index.php/Manage/News/index">内容管理</a>
                        </li>
                        <li>
                            <a href="/tpshop/index.php/Manage/News/about">单页管理</a>
                        </li>
                        <li>
                            <strong>编辑内容</strong>
                        </li>
                    ...
                    <div class="col-lg-12">
                        <div class="ibox float-e-margins">
                            ...
                            <div class="ibox-content">
                                <form  role="form" id="form" method="post"  action="/tpshop/index.php/Manage/News/save_edit_about" class="form-horizontal" />
    ...
    <script src="/tpshop/Public/js/plugins/validate/messages_zh.min.js"></script>
        <!-- Data picker -->
    <script src="/tpshop/Public/js/plugins/datapicker/bootstrap-datepicker.js"></script>
