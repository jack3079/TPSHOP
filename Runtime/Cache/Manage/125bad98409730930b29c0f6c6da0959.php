...
<a title="添加关键词" href="/tpshop/index.php/Manage/Wechat/word_add" target="right" >
...
<td>
<a href="/tpshop/index.php/Manage/Wechat/edit_word/id/<?php echo ($vo["msg_id"]); ?>" target="right"><i class="fa fa-edit text-navy"></i></a>
</td>
        ...
        $("#quanxuan").bind('click',function(){
            ...
            $("#shanchu").bind('click',function(){
                ...
                if(confirm("您确定要删除所有选中的数据吗？")){
                    ...
                    $.ajax({ 
                        type:"POST",
                        url:"/tpshop/index.php/Manage/Wechat/del_word",
                        data:"id="+array,
