...
<head>
    ...
    <link href="/tpshop/Public/js/plugins/fancybox/jquery.fancybox.css" rel="stylesheet">
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li>
                            <a href="/tpshop/index.php/Manage/Shipping/index">物流管理</a>
                        </li>
                        <li>
                            <a href="/tpshop/index.php/Manage/Freight/index">运费设置</a>
                        </li>
                        <li>
                            <strong>添加运费</strong>
                        </li>
                    ...
                    <div class="col-lg-12">
                        <div class="ibox float-e-margins">
                            ...
                            <div class="ibox-content">
                                <form  role="form" id="form" method="post"  action="/tpshop/index.php/Manage/Freight/save_freight" class="form-horizontal" >
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">快递名称</label>
                                        <div class="col-sm-10">
                                            <select class="form-control m-b" name="shipping_id">
                                            <?php if(is_array($shipping)): $i = 0; $__LIST__ = $shipping;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$s): $mod = ($i % 2 );++$i;?><option value="<?php echo ($s["s_id"]); ?>"><?php echo ($s["shipping_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>    
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">运送范围</label>
                                        <div class="col-sm-10">
                                        <?php if(is_array($china)): $i = 0; $__LIST__ = $china;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$china): $mod = ($i % 2 );++$i;?><label class="checkbox-inline">
                                             <input type="checkbox" value="<?php echo ($china->id); ?>"  name="f_area[]" id="f_area"><?php echo ($china->name); ?></label> 
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                         <input type="text" class="form-control" name="weight">
                                          <span class="help-block m-b-none">*注：只能填写数字，单位为Kg。</span>
                                        </div>
                                    </div>
                                    <div class="hr-line-dashed"></div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                         <input type="text" class="form-control" name="fist_freight">
                                         <span class="help-block m-b-none">*注：只能填写数字金额。</span>
                                        </div>
                                    </div>
                                    <div class="hr-line-dashed"></div>   
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                         <input type="text" class="form-control" name="next_freight">
                                          <span class="help-block m-b-none">*注：只能填写数字金额，每增加一次你填写的重量的价格。</span>
                                        </div>
                                    </div>
                                    <div class="hr-line-dashed"></div>                                  
