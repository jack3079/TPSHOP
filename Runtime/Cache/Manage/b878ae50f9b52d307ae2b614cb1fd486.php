                        ...
                        <div class="ibox float-e-margins">
                            ...
                            <div class="ibox-content">
                                <div class="row">
                                    <div class="col-lg-9">
                                    <ul>
                                    <li>网站名称：<?php echo ($system_info["site_name"]); ?></li>
                                    <li>网站域名：<?php echo ($system_info["server_domain"]); ?></li>
                                    <li>服务器系统：<?php echo ($system_info["server_os"]); ?></li>
                                    <li>PHP版本号：PHP <?php echo ($system_info["php_version"]); ?></li>
                                    <li>数据库信息：<?php echo ($system_info["mysql_version"]); ?></li>
                                    <li>上传最大限制：<?php echo ($system_info["upload_max_filesize"]); ?></li>
                                    <li>执行时间：<?php echo ($system_info["max_execution_time"]); ?></li>
                                    <li>服务器时区：<?php echo ($system_info["timezone"]); ?></li>
                                    </ul>
                                    </div>
                                </div>
                            </div>
