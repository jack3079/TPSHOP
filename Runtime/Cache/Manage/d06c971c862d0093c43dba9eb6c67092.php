...
<link rel="stylesheet" href="/shop/Public/js/plugins/layer/skin/layer.css" >
<body class="white-bg">
<div class="row">
<div class="col-lg-12">
...
<i class="fa fa-times"></i>
                            ...
                            <div class="ibox-content">
                                <form  role="form" id="form" method="post"  action="/shop/index.php/Manage/Wechat/save_word_add" class="form-horizontal">
                                ...
                                <li role="presentation" class="active">
                                  ...
                                  <a class="btn btn-white btn-bitbucket" href="/shop/index.php/Manage/Wechat/word_add_tuwen" target="right" >
