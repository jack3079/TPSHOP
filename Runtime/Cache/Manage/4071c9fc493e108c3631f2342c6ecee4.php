                    ...
                    <div class="col-lg-12">
                        <div class="ibox float-e-margins">
                            ...
                            <div class="ibox-content">
                                <form  role="form" id="form" method="post" action="/KeNong/index.php/Manage/System/saveSite" class="form-horizontal" enctype="multipart/form-data" />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                        <img src="/KeNong/Public/<?php echo ($system["qrcode"]); ?>"  width="100" height="100" class="thumbnail">
