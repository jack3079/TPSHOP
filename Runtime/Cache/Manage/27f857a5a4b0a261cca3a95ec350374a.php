            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li>
                            <a href="/Nongke/index.php/Manage/Ad/index">广告列表</a>
                        </li>
                        <li>
                            <strong>添加广告</strong>
                        </li>
                    ...
                    <div class="col-lg-12">
                        <div class="ibox float-e-margins">
                            ...
                            <div class="ibox-content">
                                <form  role="form" id="form" method="post"  action="/Nongke/index.php/Manage/Ad/save_ad" class="form-horizontal" enctype="multipart/form-data" />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                        <!--<img src="/Nongke/Public/<?php echo ($ad["ad_img"]); ?>"  class="thumbnail">-->
