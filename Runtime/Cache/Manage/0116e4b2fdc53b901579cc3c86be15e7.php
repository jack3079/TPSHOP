            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li>
                            <a href="/tpshop/index.php/Manage/Admin/index">管理员管理</a>
                        </li>
                        <li>
                            <strong>管理员列表</strong>
                        </li>
                        ...
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                ...
                                <div class="ibox-tools">
                                    ...
                                    <a title="添加管理员" href="/tpshop/index.php/Manage/Admin/add_Admin" class="close-link">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped">
                                        ...
                                        <?php if(is_array($admin)): $i = 0; $__LIST__ = $admin;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                                ...
                                                <td>
                                                <a href="/tpshop/index.php/Manage/Admin/editAdmin/admin_id/<?php echo ($vo["id"]); ?>"><i class="fa fa-edit text-navy"></i></a>
                                                <a href="/tpshop/index.php/Manage/Admin/delAdmin/admin_id/<?php echo ($vo["id"]); ?>"><i class="fa  fa-trash-o text-danger"></i></a>
                                                </td>
