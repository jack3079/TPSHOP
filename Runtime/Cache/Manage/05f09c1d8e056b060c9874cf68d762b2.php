...
<head>
    ...
    <title><?php echo ($system["sitename"]); ?>后台管理中心 - 商品管理 - 品牌管理</title>
...
<body>
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li>
                            <a href="/tpshop/index.php/Manage/Goods/index">商城设置</a>
                        </li>
                        <li>
                            <a href="/tpshop/index.php/Manage/Brand/index">品牌管理</a>
                        </li>
                        <li>
                            <strong>品牌列表</strong>
                        </li>
                        ...
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                ...
                                <div class="ibox-tools">
                                    ...
                                    <a title="添加品牌" href="/tpshop/index.php/Manage/Brand/addBrand" class="close-link">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped  table-hover">
                                        ...
                                        <?php if(is_array($brand)): $i = 0; $__LIST__ = $brand;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                                <td>
                                                    <input type="checkbox"  class="i-checks"  value="<?php echo ($vo["b_id"]); ?>" name="b_id[]">
                                                    <span><?php echo ($vo["b_id"]); ?></span>
                                                </td>
                                                <td><?php echo ($vo["brand"]); ?></td>
                                                <td>
                                                <a class="fancybox" href="/tpshop/Public/<?php echo ($vo["brand_pic"]); ?>" title="<?php echo ($vo["brand"]); ?>">
                                                <img alt="<?php echo ($vo["brand"]); ?>" src="/tpshop/Public/<?php echo ($vo["brand_pic"]); ?>" style=" height:50px; width:auto;">
                                                </a>
                                                </td>
                                                <td><?php echo ($vo["srot"]); ?></td>
                                                <td>
                                                <a href="/tpshop/index.php/Manage/Brand/editbrand/id/<?php echo ($vo["b_id"]); ?>"><i class="fa fa-edit text-navy"></i></a>
                                                <a href="/tpshop/index.php/Manage/Brand/del_brand/id/<?php echo ($vo["b_id"]); ?>"><i class="fa  fa-trash-o text-danger"></i></a>
                                                </td>
    ...
    <script src="/tpshop/Public/js/plugins/fancybox/jquery.fancybox.js"></script>
    <script>
        ...
        $("#quanxuan").bind('click',function(){
            ...
            $("#shanchu").bind('click',function(){
                ...
                if(confirm("您确定要删除所有选中的数据吗？")){
                    ...
                    $.ajax({ 
                        type:"POST",
                        url:"/tpshop/index.php/Manage/Brand/del_brand",
                        data:"id="+array,
