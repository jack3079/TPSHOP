                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li><a href="/tpshop/index.php/Manage/Wechat/Text">图文回复</a>
                            </li>
                        ...
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                ...
                                <div class="ibox-tools">
                                    ...
                                    <a title="添加商品" href="/tpshop/index.php/Manage/Goods/addGoods" class="close-link">
                            ...
                            <form action="/tpshop/index.php/Manage/Goods/Index"  method="post">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-hover">
                                        ...
                                        <?php if(is_array($goods)): $i = 0; $__LIST__ = $goods;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                                ...
                                                <td>
                                                <a class="fancybox" href="/tpshop/Public/<?php echo ($vo["photo"]); ?>" title="<?php echo ($vo["title"]); ?>">
                                                <img alt="<?php echo ($vo["title"]); ?>" src="/tpshop/Public/<?php echo ($vo["photo"]); ?>" style=" height:50px; width:auto;">
                                                </a>
                                                </td>
                                                ...
                                                <td>
                                                <a href="/tpshop/index.php/Manage/Goods/editGoods/id/<?php echo ($vo["id"]); ?>"><i class="fa fa-edit text-navy"></i></a>
                                                <a href="/tpshop/index.php/Manage/Goods/delGoods/id/<?php echo ($vo["id"]); ?>"><i class="fa  fa-trash-o text-danger"></i></a>
                                                </td>
        ...
        $("#quanxuan").bind('click',function(){
            ...
            $("#shanchu").bind('click',function(){
                ...
                if(confirm("您确定要删除所有选中数据吗？")){
                    ...
                    $.ajax({ 
                        type:"POST",
                        url:"/tpshop/index.php/Manage/Goods/delGoods",
                        data:"id="+array,
