...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        ...
        <ol class="breadcrumb">
            ...
            <li>
                <a href="/KeNong/index.php/Manage/Wechat/sucai">素材管理</a>
            </li>
            <li>
                <strong>添加素材</strong>
            </li>
    ...
    <div class="tab-content"> 
      ...
      <div id="form" action="" class="form-horizontal form-center">
        <div class="material_form">
            ...
            <?php if(a!=b): ?><form data-index='0' class="appmsg_item edit_item editing">
                    <p class="time">时间</p>
                    <div class="main_img">
                        <img src="/KeNong/Public/admin/img/no_cover_pic.png" data-coverid="0"/>
               ...
               <?php if(is_array($tuwen)): $i = 0; $__LIST__ = $tuwen;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><form data-index='key+1' class="appmsg_sub_item edit_item">
...
<script charset="utf-8" src="/KeNong/Public/admin/js/admin_common.js"></script>  
<script charset="utf-8" src="/KeNong/Public/admin/js/jquery.dragsort-0.5.2.min.js"></script>     
...
function addMsg(){
	...
	var addHtml = $('<form data-index="'+curCount+'" class="appmsg_sub_item edit_item">'+
                    '<p class="title"></p>'+
                    '<div class="main_img">'+
                        '<img src="/KeNong/Public/admin/img/no_cover_pic_s.png" data-coverid="0"/>'+
                    '</div>'+
                    '<input type="hidden" name="title" placeholder="这是标题"/>'+
                    '<input type="hidden" name="cover_id" value="0"/>'+
                    '<input type="hidden" name="intro" placeholder="这是摘要描述"/>'+
