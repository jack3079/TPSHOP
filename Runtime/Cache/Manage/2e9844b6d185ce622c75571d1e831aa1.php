            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li>
                            <a href="/tpshop/index.php/Manage/Pay/alipay">支付设置</a>
                        </li>
                        <li>
                    ...
                    <div class="col-lg-12">
                        <div class="ibox float-e-margins">
                            ...
                            <div class="ibox-content">
                                <form  role="form" id="form" method="post" action="/tpshop/index.php/Manage/Pay/save_alipay" class="form-horizontal" />
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">支付宝账号</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="alipay" value="<?php echo ($payconfig["alipay"]); ?>" placeholder="请输入支付宝账号">
                                            <span class="help-block m-b-none">支付宝接口申请：http://www.alipay.com</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="aliid" value="<?php echo ($payconfig["aliid"]); ?>" placeholder="请输入合作者身份ID">
                                        </div>
                                    </div>
                                    <div class="hr-line-dashed"></div>
                                    
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">密钥KEY</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="alikey" value="<?php echo ($payconfig["alikey"]); ?>" placeholder="请输入支付宝密钥">
                                        </div>
                                    </div>
                                    <div class="hr-line-dashed"></div>
