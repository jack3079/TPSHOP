        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form  role="form" id="form" method="post" action="/shop/index.php/Manage/System/saveSite" class="form-horizontal" enctype="multipart/form-data" />
                                  ...
                                  <div class="tab-content">
                                   ...
                                   <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                        <img src="/shop/Public/<?php echo ($system["logo"]); ?>"   height="100" class="thumbnail">
