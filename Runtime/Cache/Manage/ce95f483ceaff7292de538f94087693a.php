                    ...
                    <div class="col-lg-12">
                        <div class="ibox float-e-margins">
                            ...
                            <div class="ibox-content">
                                <form  role="form" id="form" method="post" action="/Nongke/index.php/Manage/System/saveSite" class="form-horizontal" enctype="multipart/form-data" />
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">微信公众号</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="wechat" value="<?php echo ($system["wechat"]); ?>" placeholder="请输入微信公众号">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="weiurl" value="<?php echo ($system["weiurl"]); ?>" placeholder="请输入微信接口网址">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                        <img src="/Nongke/Public/<?php echo ($system["qrcode"]); ?>"  width="100" height="100" class="thumbnail">
