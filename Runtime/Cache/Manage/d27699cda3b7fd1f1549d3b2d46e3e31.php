...
<head>
    ...
    <link href="/tpshop/Public/js/plugins/datapicker/datepicker.css" rel="stylesheet">
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li>
                            <a href="/tpshop/index.php/Manage/Order/index">交易管理</a>
                        </li>
                        <li>
                            <a href="/tpshop/index.php/Manage/Order/index">订单管理</a>
                        </li>
                        <li>
                            <strong>订单列表</strong>
                        </li>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="ibox float-e-margins">
                            ...
                            <form action="/tpshop/index.php/Manage/Order/Index"  method="post">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-hover">
                                        ...
                                        <?php if(is_array($order)): $i = 0; $__LIST__ = $order;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                                ...
                                                <td>
                                                <a href="/tpshop/index.php/Manage/Order/view/id/<?php echo ($vo["o_id"]); ?>"><i class="fa fa-eye  text-navy"></i></a>
                                                <a href="/tpshop/index.php/Manage/Order/del_order/id/<?php echo ($vo["o_id"]); ?>"><i class="fa  fa-trash-o text-danger"></i></a>
                                                </td>
        ...
        $("#quanxuan").bind('click',function(){
            ...
            $("#shanchu").bind('click',function(){
                ...
                if(confirm("您确定要删除所有选中数据吗？")){
                    ...
                    $.ajax({ 
                        type:"POST",
                        url:"/tpshop/index.php/Manage/Order/del_order",
                        data:"id="+array,
