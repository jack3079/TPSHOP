                    ...
                    <div class="col-lg-12">
                        <div class="ibox float-e-margins">
                            ...
                            <div class="ibox-content">
                                <form  role="form" id="form" method="post"  action="/Nongke/index.php/Manage/News/save_about" class="form-horizontal" />
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">标题</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="n_title"   placeholder="请输入标题">
                                        </div>
                                    </div>
                                  ...
                                  <div class="form-group" id="data_1">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" name="n_type" value="0">
