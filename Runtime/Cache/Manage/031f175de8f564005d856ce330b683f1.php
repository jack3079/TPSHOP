...
<head>
    ...
    <title><?php echo ($system["sitename"]); ?>后台管理中心 - 广告管理 - 添加广告</title>
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li>
                            <a href="/tpshop/index.php/Manage/Ad/index">广告列表</a>
                        </li>
                        <li>
                            <strong>添加广告</strong>
                        </li>
                    ...
                    <div class="col-lg-12">
                        <div class="ibox float-e-margins">
                            ...
                            <div class="ibox-content">
                                <form  role="form" id="form" method="post"  action="/tpshop/index.php/Manage/Ad/save_ad" class="form-horizontal" enctype="multipart/form-data" />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                        <!--<img src="/tpshop/Public/<?php echo ($ad["ad_img"]); ?>"  class="thumbnail">-->
                                        <input  type="file" name="ad_img" id="exampleInputFile"  >
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="ad_url"  placeholder="请输入广告链接网址">
