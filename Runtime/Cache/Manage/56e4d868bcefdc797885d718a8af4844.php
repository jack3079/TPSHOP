            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li>
                            <a href="/kenong/index.php/Manage/Rank/index">客户组管理</a>
                        </li>
                        <li>
                            <strong>客户组列表</strong>
                        </li>
                        ...
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                ...
                                <div class="ibox-tools">
                                    ...
                                    <a title="添加管理员" href="/kenong/index.php/Manage/Rank/addRank" class="close-link">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped">
                                        ...
                                        <?php if(is_array($rank)): $i = 0; $__LIST__ = $rank;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                                ...
                                                <td>
                                                <a href="/kenong/index.php/Manage/Rank/editRank/id/<?php echo ($vo["r_id"]); ?>"><i class="fa fa-edit text-navy"></i></a>
                                                <a href="/kenong/index.php/Manage/Rank/del_rank/id/<?php echo ($vo["r_id"]); ?>"><i class="fa  fa-trash-o text-danger"></i></a>
                                                </td>
