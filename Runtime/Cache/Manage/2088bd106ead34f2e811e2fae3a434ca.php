            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li>
                            <a href="/Nongke/index.php/Manage/NewsCate/index">分类管理</a>
                        </li>
                        <li>
                            <strong>添加分类</strong>
                        </li>
                    ...
                    <div class="col-lg-12">
                        <div class="ibox float-e-margins">
                            ...
                            <div class="ibox-content">
                                <form  role="form" id="form" method="post"  action="/Nongke/index.php/Manage/NewsCate/add_cate" class="form-horizontal" />
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">分类名称</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="c_title" placeholder="请输入分类名称">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                      ...
                                      <div class="col-sm-10">
                                            <label class="checkbox-inline">
                                             <input name="c_type" type="radio" value="0" checked>单页分类
                                             </label> 
                                             <label class="checkbox-inline">
                                             <input name="c_type" type="radio" value="1">新闻分类
                                             </label>  
                                        </div>
                                    </div>
                                    <div class="hr-line-dashed"></div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            <?php if(is_array($category)): $i = 0; $__LIST__ = $category;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo['c_id']); ?>"><?php echo ($vo['c_title']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                            </select>
