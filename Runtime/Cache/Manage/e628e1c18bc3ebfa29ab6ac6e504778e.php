            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li>
                            <a href="/KeNong/index.php/Manage/Goods/index">商城设置</a>
                        </li>
                        <li>
                            <a href="/KeNong/index.php/Manage/Brand/index">品牌列表</a>
                        </li>
                        <li>
                            <strong>添加品牌</strong>
                        </li>
                    ...
                    <div class="col-lg-12">
                        <div class="ibox float-e-margins">
                            ...
                            <div class="ibox-content">
                                <form  role="form" id="form" method="post"  action="/KeNong/index.php/Manage/Brand/save_brand" class="form-horizontal" enctype="multipart/form-data" />
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">品牌名称</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="brand"  placeholder="请输入品牌名称">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                        <input  type="file" name="brand_pic" id="exampleInputFile"  >
                                        <span class="help-block m-b-none">请上传品牌LOGO</span>
                                        </div>
                                    </div>
                                    <div class="hr-line-dashed"></div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="sort"  placeholder="请输入排列序号">
