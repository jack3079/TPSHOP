...
<html lang="zh"><head>
    ...
    <link rel="stylesheet" type="text/css" href="/Nongke/Public/css/bootstrap.min.css" />    
    <link rel="stylesheet" type="text/css" href="/Nongke/Public/admin/css/login.css" />
    <!--引入JS文件-->
    ...
    <div class="container">
      <form class="form-signin" action="<?php echo U('public/login');?>" method="post" role="form">
        ...
        <div class="login-wrap">
            ...
            <img class="vcode" src="/Nongke/index.php/Manage/Public/verify" onclick="this.src='/Nongke/index.php/Manage/Public/verify?'+new Date().getTime();"/>
