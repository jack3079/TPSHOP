                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-hover">
                                        ...
                                        <?php if(is_array($order)): $i = 0; $__LIST__ = $order;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                                ...
                                                <td><?php if($vo["status"] == 0): ?>未付款<?php elseif($vo["status"] == 1): ?>待发货<?php elseif($vo["status"] == 2): ?>已发货<?php else: ?>交易完成<?php endif; ?></td>
                                                <td>
                                                <a href="/Nongke/index.php/Manage/Goods/editGoods/id/<?php echo ($vo["o_id"]); ?>"><i class="fa fa-edit text-navy"></i></a>
                                                <a href="/Nongke/index.php/Manage/Goods/delGoods/id/<?php echo ($vo["o_id"]); ?>"><i class="fa  fa-trash-o text-danger"></i></a>
                                                </td>
