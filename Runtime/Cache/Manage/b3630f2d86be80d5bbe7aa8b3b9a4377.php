            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li>
                            <a href="/tpshop/index.php/Manage/Shipping/index">快递列表</a>
                        </li>
                        <li>
                            <strong>快递列表</strong>
                        </li>
                        ...
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                ...
                                <div class="ibox-tools">
                                    ...
                                    <a title="添加快递" href="/tpshop/index.php/Manage/Shipping/addShipping" class="close-link">
                            ...
                            <div class="ibox-content">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped  table-hover">
                                        ...
                                        <tbody>
                                        <?php if(is_array($shipping)): $i = 0; $__LIST__ = $shipping;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                                <td>
                                                    <input type="checkbox"  class="i-checks"  value="<?php echo ($vo["s_id"]); ?>" name="s_id[]">
                                                    <span><?php echo ($vo["s_id"]); ?></span>
                                                </td>
                                                <td><?php echo ($vo["shipping_name"]); ?></td>
                                                <td>
                                                <a href="/tpshop/index.php/Manage/Shipping/del_shipping/id/<?php echo ($vo["s_id"]); ?>"><i class="fa  fa-trash-o text-danger"></i></a>
                                                </td>
        ...
        $("#quanxuan").bind('click',function(){
            ...
            $("#shanchu").bind('click',function(){
                ...
                if(confirm("您确定要删除所有选中的数据吗？")){
                    ...
                    $.ajax({ 
                        type:"POST",
                        url:"/tpshop/index.php/Manage/Shipping/del_shipping",
                        data:"id="+array,
