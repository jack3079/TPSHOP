                        ...
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                ...
                                <div class="ibox-tools">
                                    ...
                                    <a title="添加管理员" href="/Nongke/index.php/Manage/Rank/addRank" class="close-link">
                            ...
                            <div class="ibox-content">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                        <?php if(is_array($rank)): $i = 0; $__LIST__ = $rank;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                                <td>
                                                    <span><?php echo ($vo["r_id"]); ?></span>
                                                </td>
                                                <td><?php echo ($vo["r_name"]); ?></td>
                                                <td><?php echo ($vo["discounts"]); ?>%</td>
                                                <td><?php echo ($vo["about"]); ?></td>
                                                <td>
                                                <a href="/Nongke/index.php/Manage/Rank/editRank/id/<?php echo ($vo["r_id"]); ?>"><i class="fa fa-edit text-navy"></i></a>
                                                <a href="/Nongke/index.php/Manage/Rank/del_rank/id/<?php echo ($vo["r_id"]); ?>"><i class="fa  fa-trash-o text-danger"></i></a>
                                                </td>
