...
<head>
    ...
    <title><?php echo ($system["sitename"]); ?>后台管理中心 - 客户管理 - 客户组管理</title>
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li>
                            <a href="/Nongke/index.php/Manage/Rank/index">客户组管理</a>
                        </li>
                        <li>
                            <strong>修改客户组信息</strong>
                        </li>
                    </ol>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="ibox float-e-margins">
                            ...
                            <?php if(is_array($rank)): $i = 0; $__LIST__ = $rank;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><form  role="form" id="form" method="post"  action="/Nongke/index.php/Manage/Rank/save_edit_rank" class="form-horizontal"/>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">客户组名称</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="r_name"  value="<?php echo ($vo["r_name"]); ?>"  placeholder="请输入客户组名称">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10 input-group m-b">                                        
                                            <input type="text" class="form-control" name="discounts" value="<?php echo ($vo["discounts"]); ?>"  placeholder="请输入折扣率"><span class="input-group-addon">%</span>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea name="about" cols="3" rows="3" class="form-control" placeholder="请输入简介" ><?php echo ($vo["about"]); ?></textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" name="r_id" value="<?php echo ($vo["r_id"]); ?>">
