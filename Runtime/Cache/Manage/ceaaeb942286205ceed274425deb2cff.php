                        ...
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                ...
                                <div class="ibox-tools">
                                    ...
                                    <a title="添加运费" href="/tpshop/index.php/Manage/Freight/addFreight" class="close-link">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped  table-hover">
                                        ...
                                        <?php if(is_array($freight)): $i = 0; $__LIST__ = $freight;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                                ...
                                                <td>
                                                <a href="/tpshop/index.php/Manage/Freight/del_freight/id/<?php echo ($vo["f_id"]); ?>"><i class="fa  fa-trash-o text-danger"></i></a>
                                                </td>
        ...
        $("#quanxuan").bind('click',function(){
            ...
            $("#shanchu").bind('click',function(){
                ...
                if(confirm("您确定要删除所有选中的数据吗？")){
                    ...
                    $.ajax({ 
                        type:"POST",
                        url:"/tpshop/index.php/Manage/Freight/del_freight",
                        data:"id="+array,
