                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="ibox float-e-margins">
                           ...
                           <form  role="form" id="form"  method="post" action="/tpshop/index.php/Manage/Wechat/Save_Event_Text" class="form-horizontal" />
                              ...
                              <form  role="form" id="form1" method="post" action="/tpshop/index.php/Manage/Wechat/Save_Event_Pic" class="form-horizontal"  enctype="multipart/form-data" />
