            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li>
                            <a href="/tpshop/index.php/Manage/Ad/index">广告管理</a>
                        </li>
                        <li>
                            <strong>广告列表</strong>
                        </li>
                        ...
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                ...
                                <div class="ibox-tools">
                                    ...
                                    <a title="添加广告" href="/tpshop/index.php/Manage/Ad/addad" class="close-link">
                            ...
                            <form action="/tpshop/index.php/Manage/Ad/index"  method="post">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped">
                                        ...
                                        <?php if(is_array($ad)): $i = 0; $__LIST__ = $ad;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                                ...
                                                <td>
                                                <a class="fancybox" href="/tpshop/Public/<?php echo ($vo["ad_img"]); ?>" title="<?php echo ($vo["ad_name"]); ?>">
                                                <img alt="<?php echo ($vo["ad_name"]); ?>" src="/tpshop/Public/<?php echo ($vo["ad_img"]); ?>" style=" height:50px; width:auto;">
                                                </a>
                                                </td>
                                                <td><?php echo ($vo["ad_url"]); ?></td>
                                                <td>
                                                <a href="/tpshop/index.php/Manage/Ad/editAd/adid/<?php echo ($vo["ad_id"]); ?>"><i class="fa fa-edit text-navy"></i></a>
                                                <a href="/tpshop/index.php/Manage/Ad/delAd/adid/<?php echo ($vo["ad_id"]); ?>"><i class="fa  fa-trash-o text-danger"></i></a>
                                                </td>
        ...
        $("#quanxuan").bind('click',function(){
            ...
            $("#shanchu").bind('click',function(){
                ...
                if(confirm("您确定要删除所有选中数据吗？")){
                    ...
                    $.ajax({ 
                        type:"POST",
                        url:"/tpshop/index.php/Manage/Ad/delAd",
                        data:"id="+array,
