                        ...
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                ...
                                <div class="ibox-tools">
                                    ...
                                    <a class="dropdown-toggle" data-toggle="dropdown" href="#" title="删除新闻">
                                    ...
                                    <a title="添加新闻" href="/tpshop/index.php/Manage/News/addNews" class="close-link">
                            ...
                            <form action="/tpshop/index.php/Manage/News/Index"  method="post">
                            <div class="ibox-content">
                                <div class="row">
                                    <div class="col-sm-5 m-b-xs">
                                        <select class="input-sm form-control input-s-sm inline" name="cate_id">
                                            <option value="0">请选择新闻类别</option>
                                            <?php if(is_array($cate)): $i = 0; $__LIST__ = $cate;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$c): $mod = ($i % 2 );++$i;?><option value="<?php echo ($c["c_id"]); ?>"><?php echo ($c["c_title"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?> 
                                        </select>
                                    </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-hover">
                                        ...
                                        <?php if(is_array($news)): $i = 0; $__LIST__ = $news;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                                ...
                                                <td>
                                                <a href="/tpshop/index.php/Manage/News/editNews/id/<?php echo ($vo["n_id"]); ?>"><i class="fa fa-edit text-navy"></i></a>
                                                <a href="/tpshop/index.php/Manage/News/del_about/id/<?php echo ($vo["n_id"]); ?>"><i class="fa  fa-trash-o text-danger"></i></a>
                                                </td>
        ...
        $("#quanxuan").bind('click',function(){
            ...
            $("#shanchu").bind('click',function(){
                ...
                if(confirm("您确定要删除所有选中数据吗？")){
                    ...
                    $.ajax({ 
                        type:"POST",
                        url:"/tpshop/index.php/Manage/News/del_about",
                        data:"id="+array,
