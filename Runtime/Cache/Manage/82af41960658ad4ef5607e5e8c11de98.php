...
<link rel="stylesheet" href="/tpshop/Public/js/plugins/layer/skin/layer.css" >
<body class="white-bg">
<div class="row">
<div class="col-lg-12">
...
<i class="fa fa-times"></i>
                            ...
                            <div class="ibox-content">
                                <form  role="form" id="form" method="post"  action="/tpshop/index.php/Manage/Wechat/save_word_add" class="form-horizontal">
