...
<i class="fa fa-times"></i>
                            ...
                            <div class="ibox-content">
                                <form  role="form" id="form" method="post"  action="/KeNong/index.php/Manage/Wechat/save_text_add" class="form-horizontal" enctype="multipart/form-data" />
                                ...
                                <li role="presentation" >
                                  <a class="btn btn-white btn-bitbucket" href="/KeNong/index.php/Manage/Wechat/word_add" target="right" >
