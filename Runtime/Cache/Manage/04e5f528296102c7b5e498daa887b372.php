                        ...
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                ...
                                <div class="ibox-tools">
                                    ...
                                    <a title="添加客户" href="/kenong/index.php/Manage/User/addUser" class="close-link">
                            ...
                            <form action="/kenong/index.php/Manage/User/Index"  method="post">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-hover">
                                        ...
                                        <?php if(is_array($user)): $i = 0; $__LIST__ = $user;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                                ...
                                                <td>
                                                <a href="/kenong/index.php/Manage/User/editUser/id/<?php echo ($vo["uid"]); ?>"><i class="fa fa-edit text-navy"></i></a>
                                                <a href="/kenong/index.php/Manage/User/del_user/id/<?php echo ($vo["uid"]); ?>"><i class="fa  fa-trash-o text-danger"></i></a>
                                                </td>
        ...
        $("#quanxuan").bind('click',function(){
            ...
            $("#shanchu").bind('click',function(){
                ...
                if(confirm("您确定要删除所有选中数据吗？")){
                    ...
                    $.ajax({ 
                        type:"POST",
                        url:"/kenong/index.php/Manage/User/del_user",
                        data:"id="+array,
