...
<head>
    ...
    <link href="/NONGKE/Public/css/animate.css" rel="stylesheet">
    <link href="/NONGKE/Public/css/style.css" rel="stylesheet">
        <!-- scripts -->
    <script src="/NONGKE/Public/js/jquery-2.1.1.min.js"></script>
    <script src="/NONGKE/Public/js/bootstrap.min.js"></script>
...
<!--header-->    
    ...
    <div class="ibox-content">
        <div class="col-md-10 col-md-offset-1 m-t m-b">
            <p class="text-center">
            <?php if($system["logo"] == null): ?><img src="/NONGKE/Public/img/logo.png">
            <?php else: ?>
            <img title="<?php echo ($system["sitename"]); ?>" src="/NONGKE/Public/<?php echo ($system["logo"]); ?>"><?php endif; ?>
            </p>
    ...
    <div class="carousel slide" id="carousel1">
        <div class="carousel-inner" role="listbox">  
         <div class="item active">
                <img  class="img-preview" src="/NONGKE/Public/<?php echo ($adimg["ad_img"]); ?>">  
        </div>          
        <?php if(is_array($ad)): $i = 0; $__LIST__ = $ad;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ad): $mod = ($i % 2 );++$i;?><div class="item ">
            <a href="<?php echo ($ad["ad_url"]); ?>" title="<?php echo ($ad["ad_name"]); ?>" target="_top">
                <img alt="<?php echo ($ad["ad_name"]); ?>" class="img-preview" src="/NONGKE/Public/<?php echo ($ad["ad_img"]); ?>">
            </a>    
...
<div class="row product-list">
  <div class="col-md-4">
      <section class="panel">
          <div class="pro-img-box">
              <img src="/NONGKE/Public/img/3.jpg" alt=""/>
  ...
  <div class="col-md-4">
      <section class="panel">
          <div class="pro-img-box">
              <img class="" src="/NONGKE/Public/img/3.jpg" alt=""/>
              <a href="#" class="adtocart">
                  <i class="glyphicon glyphicon-shopping-cart"></i>
              </a>
          </div>
